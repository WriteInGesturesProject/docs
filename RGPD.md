...
Ainsi il faudra prévoir les différentes finalité, dans notre cas dans un premier temps le suivis de la progression des enfants et dans un second temps l’étude des données
...
De plus le consentement de l’utilisateur doit être recueillis pour l’utilisation des données le concernant. 
...
Cependant il faudra quand même faire apparaître toutes les informations necessaire dans la section “à propos” de l’application. 
